...
export default function ProductDetailsPage() {
  ...
  const product = {
    ...
    title: "Smartphone",
    price: "$699.99",
    description: "A high-performance smartphone with advanced features and sleek design.",
    specifications: {
      brand: "Apple",
      model: "XPro Max",
    ...
    image: "/images/smartphone.png", // Corrected image path
  };
  ...
  const relatedProducts = [
    {
      ...
      name: "Laptop",
      price: "$1299.99",
      image: "/images/laptop.png", // Corrected image path
    },
    {
      id: 3,
      name: "Headphones",
      price: "$199.99",
      image: "/images/headphone.png", // Corrected image path
    },
    {
      id: 4,
      name: "Watch",
      price: "$499.99",
      image: "/images/watch.png", // Corrected image path
    },
    {
      id: 5,
      name: "Camera",
      price: "$699.99",
      image: "/images/camera.png", // Corrected image path
    },
  ];

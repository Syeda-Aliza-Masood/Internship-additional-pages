const SendQuoteSection = () => {
  return (
    <div className="w-[1180px] h-[420px] relative rounded-md mx-auto">
      ...
      <div className="w-full h-full bg-cover bg-center rounded-md" style={{ backgroundImage: 'url("22.png")' }}>
      ...
      <div className="absolute top-1/2 right-3 transform -translate-y-1/2 w-full sm:w-3/4 md:w-2/5 lg:w-2/5 bg-white p-4 rounded-md shadow-lg">
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-4 text-center sm:text-left">Send Quote to Suppliers</h2>
